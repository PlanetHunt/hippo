...
public enum MatlabFunctionType {
	...
	MATLAB_STEP_HANDLER("Does the steps handling in Matlab, without usage of events.", "matlabStepHandler(orbital_elements, timestamp, current_mass, last_step_flag)",false, false);
