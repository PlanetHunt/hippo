...
public enum MatlabFunctionType {
	...
	MATLAB_STEP_HANDLER("Does the steps handling in Matlab, without usage of events.", "matlabStepHandler(orbital_elements, position, velocity, timestamp, current_mass)",false, false);
