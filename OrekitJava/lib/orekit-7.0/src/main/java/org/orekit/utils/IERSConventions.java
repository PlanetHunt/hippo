...
public enum IERSConventions {
    ...
    IERS_1996 {
        ...
        /** Frequency dependence model for kâ‚‚â‚€. */
        ...
        public TimeFunction<double[]> getXYSpXY2Function()
            ...
            // X = 2004.3109â€³t - 0.42665â€³tÂ² - 0.198656â€³tÂ³ + 0.0000140â€³tâ�´
            //     + 0.00006â€³tÂ² cos Î© + sin Îµ0 { Î£ [(Ai + Ai' t) sin(ARGUMENT) + Ai'' t cos(ARGUMENT)]}
            //     + 0.00204â€³tÂ² sin Î© + 0.00016â€³tÂ² sin 2(F - D + Î©),
            ...
            // Y = -0.00013â€³ - 22.40992â€³tÂ² + 0.001836â€³tÂ³ + 0.0011130â€³tâ�´
            //     + Î£ [(Bi + Bi' t) cos(ARGUMENT) + Bi'' t sin(ARGUMENT)]
            //    - 0.00231â€³tÂ² cos Î© âˆ’ 0.00014â€³tÂ² cos 2(F - D + Î©)
            ...
            // s = -XY/2 + 0.00385â€³t - 0.07259â€³tÂ³ - 0.00264â€³ sin Î© - 0.00006â€³ sin 2Î©
            //     + 0.00074â€³tÂ² sin Î© + 0.00006â€³tÂ² sin 2(F - D + Î©)
            ...
            return new TimeFunction<double[]>() {
                ...
                public double[] value(final AbsoluteDate date) {
                    ...
                    return new double[] {
                        ...
                        // âˆ†Câ‚‚â‚� = âˆ’1.333 Ã— 10â�»â�¹ (mâ‚� âˆ’ 0.0115mâ‚‚)
                        // âˆ†Sâ‚‚â‚� = âˆ’1.333 Ã— 10â�»â�¹ (mâ‚‚ + 0.0115mâ‚�)
                        ...
                        // âˆ†Câ‚‚â‚� = âˆ’1.333 Ã— 10â�»â�¹ (mâ‚� + 0.0115mâ‚‚)
                        // âˆ†Sâ‚‚â‚� = âˆ’1.333 Ã— 10â�»â�¹ (mâ‚‚ âˆ’ 0.0115mâ‚�)
                        ...
                        // âˆ’Î©Â²rÂ²/2 sin 2Î¸ Re [kâ‚‚(mâ‚� âˆ’ imâ‚‚) exp(iÎ»)] where kâ‚‚ is the complex
                        // number 0.3077 + 0.0036i, so the real part in the previous equation is:
                        // A[Re(kâ‚‚) mâ‚� + Im(kâ‚‚) mâ‚‚)] cos Î» + A[Re(kâ‚‚) mâ‚‚ - Im(kâ‚‚) mâ‚�] sin Î»
                        // identifying this with âˆ†Câ‚‚â‚� cos Î» + âˆ†Sâ‚‚â‚� sin Î» we get:
                        // âˆ†Câ‚‚â‚� = A Re(kâ‚‚) [mâ‚� + Im(kâ‚‚)/Re(kâ‚‚) mâ‚‚)]
                        // âˆ†Sâ‚‚â‚� = A Re(kâ‚‚) [mâ‚‚ - Im(kâ‚‚)/Re(kâ‚‚) mâ‚�)]
                        // and Im(kâ‚‚)/Re(kâ‚‚) is very close to +0.00115
...
//                    withSinCos(0, 18, pico, 16, pico).
        ...
        /** Compute pole wobble variables mâ‚� and mâ‚‚.
         * @param date current date
         * @param eopHistory EOP history
         * @return array containing mâ‚� and mâ‚‚
         */
            ...
            return new TimeFunction<double[]>() {
                ...
                public double[] value(final AbsoluteDate date) {
                    ...
                    return new double[] {
                        ...
                        // âˆ†Câ‚‚â‚� = âˆ’2.1778 Ã— 10â�»Â¹â�° (mâ‚� âˆ’ 0.01724mâ‚‚)
                        // âˆ†Sâ‚‚â‚� = âˆ’1.7232 Ã— 10â�»Â¹â�° (mâ‚‚ âˆ’ 0.03365mâ‚�)
     ...
     * Ïˆ<sub>A</sub> (around Z axis), Ï‰<sub>A</sub> (around X axis)
     * and Ï‡<sub>A</sub> (around Z axis). The constant angle Îµâ‚€
     ...
     * <p>
     * The function returned computes the two classical angles Î”Î¨ and Î”Îµ,
     ...
     * </p>
     * @return function computing the nutation in longitude Î”Î¨ and Î”Îµ
     ...
     * @param ut1 UT1 time scale
     * @return frequency dependence model for tides computation (Î”Câ‚‚â‚€, Î”Câ‚‚â‚�, Î”Sâ‚‚â‚�, Î”Câ‚‚â‚‚, Î”Sâ‚‚â‚‚).
     * @exception OrekitException if table cannot be loaded
     * @since 6.1
     */
    ...
    /** Get the permanent tide to be <em>removed</em> from Î”Câ‚‚â‚€ when zero-tide potentials are used.
     ...
     * @param eopHistory EOP history
     * @return model for solid pole tide (Î”Câ‚‚â‚€, Î”Câ‚‚â‚�, Î”Sâ‚‚â‚�, Î”Câ‚‚â‚‚, Î”Sâ‚‚â‚‚).
     * @exception OrekitException if table cannot be loaded
     * @since 6.1
     */
     ...
     * @param eopHistory EOP history
     * @return model for ocean pole tide (Î”Câ‚‚â‚€, Î”Câ‚‚â‚�, Î”Sâ‚‚â‚�, Î”Câ‚‚â‚‚, Î”Sâ‚‚â‚‚).
     * @exception OrekitException if table cannot be loaded
     * @since 6.1
     */
     ...
     * Î´Î”Ïˆ/Î´Î”Îµ to Î´X/Î´Y.
     * <ul>
     * <li>Î´Î”Ïˆ/Î´Î”Îµ nutation corrections are used with the equinox-based paradigm.</li>
     * <li>Î´X/Î´Y nutation corrections are used with the Non-Rotating Origin paradigm.</li>
     * </ul>
     * @since 6.1
     */
    public interface NutationCorrectionConverter {
         ...
         * @param date current date
         * @param ddPsi Î´Î”Ïˆ part of the nutation correction
         * @param ddEpsilon Î´Î”Îµ part of the nutation correction
         * @return array containing Î´X and Î´Y
        ...
        /** Convert nutation corrections.
         * @param date current date
         * @param dX Î´X part of the nutation correction
         * @param dY Î´Y part of the nutation correction
         * @return array containing Î´Î”Ïˆ and Î´Î”Îµ
         * @exception OrekitException if correction cannot be converted
         */
     ...
     * Guinot, B., and McCarthy, D. D., 2000, â€œ,â€� Astronomy and Astrophysics, 355(1), pp. 398â€“405.
     * </p>
     * <p>
